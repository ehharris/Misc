...
void FCFS(Process Processes[], int number)
{
    ...
    //---------End of Processing
    Display_Output(p, number, chart, number, "FCFS2");
...
void SJFP(Process Processes[],int number)
{
    ...
    //---------End of Processing
    Display_Output(p, number, SJFPchart, chartIndex, "SJFP2");
}
//------------------PRIORITY---------------------------------------
void PRIORITY(Process Processes[], int number)
{
    ...
    //---------End of Processing
    Display_Output(p, number, PRIORITYchart, chartIndex, "PRIORITY2");
